...
<div>
  <div className="about">
    <div className="container">
      <div className="content">
        <h2 className="title">About <span>US</span></h2>
        <div className="aboutadd"> <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dicta obcaecati officiis qui consequatur beatae? Eaque optio
            rerum quo nisi nobis ipsa, nemo quae officia labore enim possimus quisquam non iste?
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora obcaecati dignissimos sed nostrum inventore,
            minima fuga corporis vel. Iusto iure aut nulla iste nostrum 
            laboriosam corporis aspernatur quasi explicabo quo?</p> 
        ...
        <div className="social">
          <hr />
          <i className="fa-brands fa-twitter" style={{width: 40}} />
          <i className="fa-brands fa-facebook-f" style={{width: 40}} />
          <i className="fa-brands fa-linkedin" style={{width: 40}} />
          <i className="fa-brands fa-instagram" style={{width: 40}} />
          <hr />
        </div>
      </div>
      <div className="row">
